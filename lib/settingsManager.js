...
export class SettingsManager {
    ...
    _migrateNotificationSettings() {
        try {
            ...
            // 检查是否存在旧的设置项
            const hasOldSettings = this.settings.get_user_value('hook-normal-exit') !== null || 
            ...
            if (hasOldSettings) {
                ...
                // 迁移消息设置
                const normalExitMessage = this.settings.get_string('normal-exit-message');
                const abnormalExitMessage = this.settings.get_string('abnormal-exit-message');
